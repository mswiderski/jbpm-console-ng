...
package org.jbpm.console.ng.ht.forms.client.editors.taskform.popup;
...
public class FormDisplayPopupPresenter {
    ...
    private native void publish( FormDisplayPopupPresenter fdp )/*-{
        $wnd.completeTask = function (from) {
            fdp.@org.jbpm.console.ng.ht.forms.client.editors.taskform.popup.FormDisplayPopupPresenter::completeTask(Ljava/lang/String;)(from);
        }

        $wnd.startTask = function (from) {
            fdp.@org.jbpm.console.ng.ht.forms.client.editors.taskform.popup.FormDisplayPopupPresenter::startTask(Ljava/lang/String;)(from);
        }

        $wnd.saveTaskState = function (from) {
            fdp.@org.jbpm.console.ng.ht.forms.client.editors.taskform.popup.FormDisplayPopupPresenter::saveTaskState(Ljava/lang/String;)(from);
        }

        $wnd.startProcess = function (from) {
            fdp.@org.jbpm.console.ng.ht.forms.client.editors.taskform.popup.FormDisplayPopupPresenter::startProcess(Ljava/lang/String;)(from);
        }
    }-*/;
